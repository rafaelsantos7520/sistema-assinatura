...
export default function SubscriberProfilePage() {
  ...
  const validateProfile = () => {
    ...
    if (!profileForm.full_name.trim()) return 'Nome completo e obrigatorio'
    if (!emailRegex.test(profileForm.contact_email)) return 'E-mail invalido'
    if (!whatsappRegex.test(profileForm.whatsapp_number.replace(/\s/g, ''))) return 'WhatsApp invalido'
    return null
  }
